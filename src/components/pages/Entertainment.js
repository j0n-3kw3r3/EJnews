...
const url = `https://newsdata.io/api/1/news?apikey=${key}&language=en&category=entertainment`
  ...
  return (
    ...
    !isLoading ?
      <div className="py-[2rem]">
        <h1 className=" text-[2.5rem] pb-[2rem] font-bold font-header capitalize header ">Entertainment</h1>
