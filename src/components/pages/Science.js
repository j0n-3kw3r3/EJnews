...
export default function Science({ data }) {
    const science = data.results.filter((value) => {
        const val = value.category[0].includes('science')
        return val
    }
    )
  return (
      <div className="py-[2rem]">
           <h1 className=" text-[2.5rem] pb-[2rem] font-bold font-header capitalize ">Science</h1>
